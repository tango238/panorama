...
panorama create <name>     # 新しい tmux セッションを作成し、Dashboard.md の 🟢 対応中 にカード追加して attach
panorama create <name> --task <task-name>  # ウィンドウ名 / カードのタスク名を指定
panorama create <name> --no-register       # tmux セッション作成のみ (カードを追加しない)
